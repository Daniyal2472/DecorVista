<?php
include('decorvista/header.php');
?>
    <!-- slider section -->
    <section class="slider_section ">
      <div class="play_btn">
        <a href="">
          <img src="decorvista/images/play.png" alt="">
        </a>
      </div>
            ...
            <div class="carousel-item active">
              <div class="row">
                ...
                <div class="col-md-6 img-container">
                  <div class="img-box">
                    <img src="decorvista/images/slider-img.png" alt="">
                  </div>
                </div>
              </div>
            </div>
  ...
  <section class="about_section layout_padding">
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="img-box">
            <img src="decorvista/images/about-img.png" alt="">
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="col-md-6">
            <div class="collapse show" id="collapseOne" aria-labelledby="headingOne" data-parent="#accordion">
              <div class="img_container ">
                <div class="box b-1">
                  <div class="img-box">
                    <img src="decorvista/images/t-1.jpg" alt="">
                  </div>
                  <div class="img-box">
                    <img src="decorvista/images/t-2.jpg" alt="">
                  </div>
                </div>
                <div class="box b-2">
                  <div class="img-box">
                    <img src="decorvista/images/t-3.jpg" alt="">
                  </div>
                  <div class="img-box">
                    <img src="decorvista/images/t-4.jpg" alt="">
                  </div>
                </div>
              </div>
            </div>
  ...
  <section class="discount_section  layout_padding">
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="img-box">
            <img src="decorvista/images/discount-img.png" alt="">
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      <div class="client_container layout_padding2">
        <div class="client_box b-1">
          <div class="client-id">
            <div class="img-box">
              <img src="decorvista/images/client-1.png" alt="" />
            </div>
            <div class="name">
              <h5>
                Magna
        ...
        <div class="client_box b-2">
          <div class="client-id">
            <div class="img-box">
              <img src="decorvista/images/client-2.png" alt="" />
            </div>
            <div class="name">
              <h5>
                Aliqua
  ...
  <script type="text/javascript" src="decorvista/js/jquery-3.4.1.min.js"></script>
  <script type="text/javascript" src="decorvista/js/bootstrap.js"></script>
